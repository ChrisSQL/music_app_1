...
public class Awakenings2018 extends AppCompatActivity {
    ...
    private final String CHANNEL_ID = "UCV6qd2kF9ShJj_vaej6AJ9Q";
    //TODO: delete
                ...
                if (nextToken != null) {
                    ...
                    parser.onFinish(new Parser.OnTaskCompleted() {
                        ...
                        public void onTaskCompleted(ArrayList<Video> list, String nextPageToken) {
                            ...
                            vAdapter.notifyDataSetChanged();
                            Toast.makeText(Awakenings2018.this, "New video added!", Toast.LENGTH_SHORT).show();
                            fab.setVisibility(View.GONE);
                        ...
                        @Override
                        public void onError() {
                            Toast.makeText(Awakenings2018.this, "Error while loading data. Please retry", Toast.LENGTH_SHORT).show();
                        }
                    });

                } else {
                    Toast.makeText(Awakenings2018.this, "Unable to load data. Please retry", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public void loadVideo() {
        ...
        parser.onFinish(new Parser.OnTaskCompleted() {
            ...
            public void onTaskCompleted(ArrayList<com.prof.youtubeparser.models.videos.Video> list, String nextPageToken) {
                ...
                vAdapter = new VideoAdapter(list, R.layout.yt_row, Awakenings2018.this);
            ...
            @Override
            public void onError() {
                Toast.makeText(Awakenings2018.this, "Error while loading data. Please retry", Toast.LENGTH_LONG).show();
                progressBar.setVisibility(View.GONE);
                mSwipeRefreshLayout.setRefreshing(false);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            android.support.v7.app.AlertDialog alertDialog = new android.support.v7.app.AlertDialog.Builder(Awakenings2018.this).create();
