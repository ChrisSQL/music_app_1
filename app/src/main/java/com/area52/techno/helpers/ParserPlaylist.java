package com.area52.techno.helpers;
 ...
 */
public class ParserPlaylist extends AsyncTask<String, Void, String> {

    private com.prof.youtubeparser.Parser.OnTaskCompleted onComplete;
    ...
    public void onFinish(com.prof.youtubeparser.Parser.OnTaskCompleted onComplete) {
