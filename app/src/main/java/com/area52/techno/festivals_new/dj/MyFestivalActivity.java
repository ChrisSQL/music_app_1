...
public class MyFestivalActivity extends AppCompatActivity {
    ...
    private void firebaseFetch(String dj) {
        ...
        myRef.orderByChild("name").startAt(dj).limitToFirst(1).addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String prevChildKey) {
                DJ dinosaur = dataSnapshot.getValue(DJ.class);
                // System.out.println(dataSnapshot.getKey() + " was " + dinosaur.height + " meters tall.");
                // Toast.makeText(MyDJActivity.this, dataSnapshot.getKey() + " was " + dinosaur.name + " name.", Toast.LENGTH_LONG).show();
                ...
                if (extras != null) {
                    ...
                    // Redirect to DJ List
                    Intent i=new Intent(MyFestivalActivity.this, MainActivityFestival.class);
                    MyFestivalActivity.this.startActivity(i);
                }
...
//                .into(profilePicture);
    ...
    private void declareVariables() {
        ...
        //    Toast.makeText(this, SoundcloudLink, Toast.LENGTH_SHORT).show();
            ...
            // Redirect to DJ List
            Intent i=new Intent(this, MainActivityFestival.class);
    ...
    private void loadUserButtons() {
        ...
        Picasso.with(MyFestivalActivity.this)
                .load(photoUrl)
                .placeholder(R.drawable.sesh_logo)
                .into(profilePicture);
