...
public class ADE extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_festivals_ade_years);
...
//                Intent i=new Intent(ADE.this,YouTubeActivityPlaylist.class);
//                i.putExtra("playlist", "PLW_7xvV4xv5iaNbNmifsESuLudowtf28L");
//                ADE.this.startActivity(i);
            }
        });
...
//                FuturActivity.this.startActivity(i);
    ...
    public void onBackPressed() {
        ...
        Intent i = new Intent(ADE.this, PlatformsActivity.class);
        i.putExtra("festival", "ADE");
        ADE.this.startActivity(i);
    }
