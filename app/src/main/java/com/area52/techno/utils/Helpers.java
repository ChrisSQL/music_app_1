...
package com.area52.techno.utils;
...
public class Helpers {
    ...
    public static class AboutDialog extends DialogFragment {
        ...
        String urlcommunity = "https://plus.google.com";
        String urltwitter = "https://twitter.com/Area52_Music";
        String urlgithub = "https://github.com/";
        String urlsource = "https://github.com/";

        String facebookurl = "https://www.facebook.com/Area-52-2080254445553495/";
        String instagramurl = "https://www.instagram.com/area52_music/?hl=en";
        String youtubeurl = "https://www.youtube.com/channel/UCy9_pwHOOtqmAMD0IwM_hKw";
        String mixcloudurl = "https://www.mixcloud.com/area52_music/";
        String emailurl = "chris@area52.club";
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            TextView facebook = (TextView) aboutBodyView.findViewById(R.id.facebook);
            TextView instagram = (TextView) aboutBodyView.findViewById(R.id.instagram);
            TextView mixcloud = (TextView) aboutBodyView.findViewById(R.id.mixcloud);
            TextView email = (TextView) aboutBodyView.findViewById(R.id.email);
            TextView youtube = (TextView) aboutBodyView.findViewById(R.id.youtube);
            ...
            mixcloud.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent i = new Intent(Intent.ACTION_VIEW);
                    i.setData(Uri.parse(mixcloudurl));
                    startActivity(i);
                }
            });
            ...
            try {
                ...
                appversion.setText("Area52 " + version);
