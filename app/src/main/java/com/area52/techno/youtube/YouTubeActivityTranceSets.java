 ...
 */
public class YouTubeActivityTranceSets extends AppCompatActivity {
    private static final String[] YOUTUBE_PLAYLISTS = {
            "PLmh4GKNPRUM_jRcc4EVR4HrK0Z-0WPGN0"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isConnected()){
            Toast.makeText(YouTubeActivityTranceSets.this,"No Internet Connection Detected",Toast.LENGTH_LONG).show();
        }
