 ...
 */
public class YouTubeActivityTechnoSets extends AppCompatActivity {
    private static final String[] YOUTUBE_PLAYLISTS = {
            "PLmh4GKNPRUM9cHFOUAXcWZwFNo8t9fLAM"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isConnected()){
            Toast.makeText(YouTubeActivityTechnoSets.this,"No Internet Connection Detected",Toast.LENGTH_LONG).show();
        }
