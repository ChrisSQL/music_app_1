...
public class TimberAppBackup extends MultiDexApplication {


    private static TimberAppBackup mInstance;

    public static synchronized TimberAppBackup getInstance() {
        return mInstance;
    }
    ...
    public void onCreate() {
        ...
        ImageLoaderConfiguration localImageLoaderConfiguration = new ImageLoaderConfiguration.Builder(this).imageDownloader(new BaseImageDownloader(this) {
            PreferencesUtility prefs = PreferencesUtility.getInstance(TimberAppBackup.this);
